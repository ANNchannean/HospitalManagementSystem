...
var summernote_en_US = __webpack_require__(9922);
...
var Table = /*#__PURE__*/function () {
  ...
  return Table_createClass(Table, [{
    ...
    value: function addRow(rng, position) {
      ...
      var vTable = new _TableResultAction(cell, _TableResultAction.where.Row, _TableResultAction.requestAction.Add, external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default()(currentTr).closest('table')[0]);
    ...
    value: function addCol(rng, position) {
      ...
      rowsGroup.push(row);
      var vTable = new _TableResultAction(cell, _TableResultAction.where.Column, _TableResultAction.requestAction.Add, external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default()(row).closest('table')[0]);
      var actions = vTable.getActionList();
    ...
    */
    ...
    value: function deleteRow(rng) {
      ...
      var vTable = new _TableResultAction(cell, _TableResultAction.where.Row, _TableResultAction.requestAction.Delete, external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default()(row).closest('table')[0]);
      var actions = vTable.getActionList();
      for (var actionIndex = 0; actionIndex < actions.length; actionIndex++) {
    ...
    value: function deleteCol(rng) {
      ...
      var row = external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default()(cell).closest('tr');
      var cellPos = row.children('td, th').index(external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default()(cell));
      var vTable = new _TableResultAction(cell, _TableResultAction.where.Column, _TableResultAction.requestAction.Delete, external_root_jQuery_commonjs_jquery_commonjs2_jquery_amd_jquery_default()(row).closest('table')[0]);
      var actions = vTable.getActionList();
      for (var actionIndex = 0; actionIndex < actions.length; actionIndex++) {
        if (!actions[actionIndex]) {
          continue;
