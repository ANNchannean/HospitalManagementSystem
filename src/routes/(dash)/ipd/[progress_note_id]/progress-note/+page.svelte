													...
													<table class="table table-sm">
														<thead>
															...
															<tr>
																...
																<td style="width: 5%;">:</td>
																<td style="width: 20%;"
																	>{find_old_visit?.vitalSign?.pulse?.toFixed(0).concat(' /min') ??
																		''}</td
																>
															</tr>
															<tr>
															...
															<tr>
																...
																<td style="width: 5%;">:</td>
																<td style="width: 55%;"
																	>{find_old_visit?.vitalSign?.height?.toFixed(0).concat(' cm') ??
																		''}</td
																>
															</tr>
															<tr>
																...
																<td style="width: 5%;">:</td>
																<td style="width: 55%;"
																	>{find_old_visit?.vitalSign?.weight?.toFixed(0).concat(' kg') ??
																		''}</td
																>
															</tr>
															<tr>
																...
																<td style="width: 5%;">:</td>
																<td style="width: 55%;"
																	>{find_old_visit?.vitalSign?.bmi?.toFixed(1).concat(' kg/m2') ??
																		''}</td
																>
															</tr>
														</thead>
